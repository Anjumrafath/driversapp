...
import 'package:driversapp/screens/forgotpassword.dart';
import 'package:driversapp/screens/mapscreen.dart';
import 'package:driversapp/screens/registerscreen.dart';
        ...
        await firebaseAuth
          ...
          userRef
            ...
            if (snap.value != null) {
              ...
              await Fluttertoast.showToast(msg: "User data not found.");
